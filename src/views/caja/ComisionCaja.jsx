...
export default function ComisionCaja() {
        ...
        <div>
            ...
            <div className="flex flex-row p-4 text-4xl text-center">
                <div className="w-full">
                   <Link to='/caja/comision/compañia' className="flex flex-col hover:bg-blue-500 text-gray-200">
                        Compañia     
                   </Link> 
                   
                </div>
                <div className="w-full">
                   <Link to='/caja/comision/taxi' className="flex flex-col hover:bg-blue-500 text-gray-200">
                        Taxistas
                   </Link> 
                </div>
            </div>
