    ...
    <div>
        ...
        <div className="flex flex-row p-4 text-4xl text-center">
            <div className="w-full">
               <Link to='/admin/administracion/usuarios' className="flex flex-col hover:bg-blue-500 text-gray-200">
                    Usuarios     
               </Link> 
               
            </div>
            <div className="w-full">
               <Link to='/admin/administracion/colaborador' className="flex flex-col hover:bg-blue-500 text-gray-200">
                    Colaborador
               </Link> 
            </div>
        </div>
