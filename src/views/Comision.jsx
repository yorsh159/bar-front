        ...
        <div>
            ...
            <div className="flex flex-row p-4 text-4xl text-center">
                <div className="w-full">
                   <Link to='/admin/comisiones/compañia' className="flex flex-col hover:bg-blue-500 text-gray-200">
                        Compañia     
                   </Link> 
                   
                </div>
                <div className="w-full">
                   <Link to='/admin/comisiones/taxi' className="flex flex-col hover:bg-blue-500 text-gray-200">
                        Taxistas
                   </Link> 
                </div>
            </div>
