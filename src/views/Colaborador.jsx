...
export default function Colaborador() {
 ...
 const{registroColaboradorEdit} = useAuth({ middleware: 'admin', url:'/admin/adminstracion/colaborador' });
    ...
    const handleSubmitEdit = async (e,id)=>{
      ...
      registroColaboradorEdit(id,datos,setErrores)
    }
      ...
      <div>
          ...
          <div className="bg-white shadow-md rounded-md px-2 py-2">
            ...
            <form>
              ...
              <button onClick={()=>handleSubmitEdit(colaborador.id)}
